...
def main():
   ...
   # print(list(medium.edges))
    ...
    nx.write_gml(small, "input_small.gml", nx.literal_stringizer())
    nx.write_gml(medium, "input_medium.gml", nx.literal_stringizer())
    nx.write_gml(large, "input_large.gml", nx.literal_stringizer())
